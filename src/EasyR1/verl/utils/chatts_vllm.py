...
from vllm.multimodal.inputs import NestedTensors, MultiModalKwargsItems
...
class Qwen2TSMultiModalProcessor(BaseMultiModalProcessor[Qwen2TSProcessingInfo]
    ...
    def _get_prompt_updates(
        ...
        ts_tokens, encoded_ts_arrays = zip(*out_mm_kwargs.get_data()["timeseries"])
